...
acf(model_1$residuals, main="ACF Plot") #assumptions met
...
##ACF plot of residuals
acf(reduced$residuals, main="ACF Plot") #assumptions met
...
##ACF plot of residuals
acf(log.result$residuals, main="ACF Plot") #assumptions met
...
#check to see if our model might need a transform
boxcox(log.result, lambda = seq(-4, 4, 1/10)) #0 within confidence interval may need to transform
...
#acf plot of residuals
acf(model_2$residuals, main="ACF Plot") #assumptions met
...
acf(result.log$residuals, main="ACF Plot") #assumptions met
